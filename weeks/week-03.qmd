...
:::{.artifact}
Class starter route: [A1 Ta/RH Spatial Field Kit](../starter_kits/ta-rh-spatial-field/README.md). Use the point template and IDW notebook when you need a transparent first field map.
:::

...
**The body is the site where the thermal field becomes consequence**
...
::: {.key}
Thermal fields matter because the body has to receive them. Air, surfaces, moisture, wind, clothing, activity, and duration become consequential only when they change body heat exchange.
:::
...
::: {.equation-card}
Use the heat-balance equation as a map of design levers, not as an engineering derivation.
...
::: {.warning}
The architectural question is not "can I solve the full physiology model?" The question is "which exchange term is my design changing?"
:::

## Heat Balance As Design-Lever Map

| Heat-exchange term | Architectural lever |
|---|---|
| convection | air movement, openings, fans, stagnant zones |
| radiation | surfaces, glazing, shade, sky exposure |
| evaporation | humidity, air movement, activity, clothing |
| conduction | contact surfaces, ground, furniture, envelope |
| storage | duration, exposure, thermal build-up |

::: {.key}
This is the Week 2 translation move: each term points to a design decision, not just a variable in a formula.
:::
...
<div class="big-equation">comfort/stress output = f(T<sub>a</sub>, RH, v<sub>a</sub>, T<sub>mrt</sub>, M, I<sub>cl</sub>, time)</div>
:::
...
## Heat Stress Is A Body Failure

Comfort asks whether a condition is acceptable. Heat stress asks whether the body can keep rejecting heat.

::: {.equation-card}
In hot-humid conditions, the dangerous direction is:

<div class="big-equation">heat production + heat gain > heat loss</div>
:::

Architectural warning signs:

- high humidity weakens evaporation;
- low air speed limits convective and evaporative relief;
- high radiant load keeps adding heat even if `Ta` looks moderate;
- long duration turns discomfort into accumulated physiological burden;
- vulnerable occupants, activity, clothing, and access to control change the risk.

::: {.key}
This is why Week 2 treats indices as claim systems. PMV, WBGT, UTCI, heat index, and adaptive comfort do not make the same promise.
:::

## Sensible And Latent Are Different Levers

Cooling air and removing moisture are related, but they are not identical design actions.

| Burden | What changes | Possible intervention |
|---|---|---|
| sensible heat | dry-bulb temperature, surface heat, stored heat | shade, insulation, cool roof, ventilation, cooling |
| latent moisture | water vapor load and evaporative potential | dehumidification, outdoor-air control, exhaust, desiccant concept |
| coupled hot-humid stress | body cannot reject enough heat | lower MRT, increase safe air movement, reduce activity exposure, provide refuge |

::: {.warning}
Do not let "more ventilation" become the default answer in Hong Kong. Fresh air may improve perceived air quality while importing latent load.
:::
...
## Thermal Indices Are Claim Systems

PMV, adaptive comfort, UTCI, WBGT, and heat index are not interchangeable labels.

Each one makes a different kind of claim:

| Claim system | Better question |
|---|---|
| PMV / PPD | What does a declared indoor heat-balance model predict for a population? |
| adaptive comfort | What indoor range is plausible under occupant adaptation and outdoor history? |
| UTCI | What outdoor thermal stress does a standard reference person receive? |
| WBGT | What heat-stress screening signal matters for work, sport, or exposure management? |
| heat index | How does hot-humid air translate into public warning language? |

::: {.key}
Choose the claim system that matches the architectural question, then state what it cannot see.
:::
...
## Indoor Comfort Claim Systems

Indoor comfort models answer different claims about bodies, rooms, and assumptions.
...
| Claim system | Inputs it cares about | Typical use | Main caution |
|---|---|---|---|
...
## Heat-Stress And Outdoor Claim Systems
